...
6. My first IF statement to validate, it displays a message telling the user to enter an amount before they can proceed.
   The second IF statement,checks if the entered amount is less than or equal to the balance,and displays a success message also shows the remaining balance after withdrawal, else checks if the entered amount is greater than the available balance,and it displays the insufficient funds message.    
